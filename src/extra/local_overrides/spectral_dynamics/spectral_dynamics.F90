...
#ifdef PROFILE_FOUR_IN_ONE
real :: profile_four_in_one_seconds = 0.0
integer :: profile_four_in_one_calls = 0
#endif
#ifdef PROFILE_VERT_ADVECTION
real :: profile_vert_advection_u_seconds = 0.0
real :: profile_vert_advection_v_seconds = 0.0
real :: profile_vert_advection_t_seconds = 0.0
integer :: profile_vert_advection_u_calls = 0
integer :: profile_vert_advection_v_calls = 0
integer :: profile_vert_advection_t_calls = 0
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
integer, parameter :: profile_region_spectral_step = 1
integer, parameter :: profile_region_press_geopot = 2
integer, parameter :: profile_region_transforms = 3
integer, parameter :: profile_region_advection = 4
integer, parameter :: profile_region_damping = 5
integer, parameter :: profile_region_leapfrog_update = 6
integer, parameter :: profile_region_tracer_correction_diag = 7
integer, parameter :: profile_dynamics_region_count = 7
character(len=32), parameter, dimension(profile_dynamics_region_count) :: profile_dynamics_region_names = (/ character(len=32) :: &
     'spectral_dynamics_step        ', &
     'press_geopot                  ', &
     'transforms                    ', &
     'advection                     ', &
     'damping                       ', &
     'leapfrog_update              ', &
     'tracer_correction_diagnostics' /)
real, dimension(profile_dynamics_region_count) :: profile_dynamics_region_seconds = 0.0
integer, dimension(profile_dynamics_region_count) :: profile_dynamics_region_calls = 0
#endif
#ifdef PROFILE_DYNAMICS_DEEP
integer, parameter :: profile_deep_transform_dt_ln_ps = 1
integer, parameter :: profile_deep_transform_dt_t = 2
integer, parameter :: profile_deep_transform_vor_div_from_uv = 3
integer, parameter :: profile_deep_transform_phis_plus_ke = 4
integer, parameter :: profile_deep_transform_future_div = 5
integer, parameter :: profile_deep_transform_future_vor = 6
integer, parameter :: profile_deep_transform_future_uv = 7
integer, parameter :: profile_deep_transform_future_t = 8
integer, parameter :: profile_deep_transform_future_ln_ps = 9
integer, parameter :: profile_deep_horizontal_advection_temperature = 10
integer, parameter :: profile_deep_vertical_advection_u = 11
integer, parameter :: profile_deep_vertical_advection_v = 12
integer, parameter :: profile_deep_vertical_advection_t = 13
integer, parameter :: profile_deep_update_tracers = 14
integer, parameter :: profile_deep_compute_corrections = 15
integer, parameter :: profile_deep_every_step_diagnostics = 16
integer, parameter :: profile_deep_tracer_horizontal_advection = 17
integer, parameter :: profile_deep_tracer_vertical_advection = 18
integer, parameter :: profile_deep_tracer_grid_to_spectral = 19
integer, parameter :: profile_deep_tracer_spectral_to_grid = 20
integer, parameter :: profile_deep_tracer_grid_horizontal_advection = 21
integer, parameter :: profile_dynamics_deep_count = 21
character(len=40), parameter, dimension(profile_dynamics_deep_count) :: profile_dynamics_deep_names = (/ character(len=40) :: &
     'transform_dt_ln_ps                    ', &
     'transform_dt_t                        ', &
...
real, dimension(profile_dynamics_deep_count) :: profile_dynamics_deep_seconds = 0.0
integer, dimension(profile_dynamics_deep_count) :: profile_dynamics_deep_calls = 0
#endif
!===============================================================================================
...
#ifdef PROFILE_DYNAMICS_REGIONS
subroutine profile_dynamics_region_begin(t0, rate)
integer, intent(out) :: t0, rate
call system_clock(t0, rate)
end subroutine profile_dynamics_region_begin
!===============================================================================================

subroutine profile_dynamics_region_end(region_id, t0, rate)
integer, intent(in) :: region_id, t0, rate
integer :: t1
call system_clock(t1)
if(rate > 0) then
  profile_dynamics_region_seconds(region_id) = profile_dynamics_region_seconds(region_id) + &
       real(t1 - t0)/real(rate)
endif
profile_dynamics_region_calls(region_id) = profile_dynamics_region_calls(region_id) + 1
end subroutine profile_dynamics_region_end
!===============================================================================================
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
subroutine profile_dynamics_deep_begin(t0, rate)
integer, intent(out) :: t0, rate
call system_clock(t0, rate)
end subroutine profile_dynamics_deep_begin
!===============================================================================================

subroutine profile_dynamics_deep_end(region_id, t0, rate)
integer, intent(in) :: region_id, t0, rate
integer :: t1
call system_clock(t1)
if(rate > 0) then
  profile_dynamics_deep_seconds(region_id) = profile_dynamics_deep_seconds(region_id) + &
       real(t1 - t0)/real(rate)
endif
profile_dynamics_deep_calls(region_id) = profile_dynamics_deep_calls(region_id) + 1
end subroutine profile_dynamics_deep_end
!===============================================================================================
#endif
...
#ifdef PROFILE_VERT_ADVECTION
integer :: profile_vert_advection_t0, profile_vert_advection_t1, profile_vert_advection_rate
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
integer :: profile_dynamics_step_t0, profile_dynamics_step_rate
integer :: profile_dynamics_region_t0, profile_dynamics_region_rate
#endif
#ifdef PROFILE_DYNAMICS_DEEP
integer :: profile_dynamics_deep_t0, profile_dynamics_deep_rate
#endif
...
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_begin(profile_dynamics_step_t0, profile_dynamics_step_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_begin(profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_press_geopot, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#endif
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_begin(profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
call trans_grid_to_spherical(dt_ln_psg, dt_ln_ps)
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_dt_ln_ps, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_transforms, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#endif
#ifdef PROFILE_VERT_ADVECTION
call system_clock(profile_vert_advection_t0, profile_vert_advection_rate)
#endif
call vert_advection(delta_t, wg, dp, ug(:,:,:,time_level), dt_grid_tmp, scheme=uv_vert_advect_scheme, form=ADVECTIVE_FORM)
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_vertical_advection_u, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_VERT_ADVECTION
call system_clock(profile_vert_advection_t1)
if(profile_vert_advection_rate > 0) then
  profile_vert_advection_u_seconds = profile_vert_advection_u_seconds + &
       real(profile_vert_advection_t1 - profile_vert_advection_t0)/real(profile_vert_advection_rate)
endif
profile_vert_advection_u_calls = profile_vert_advection_u_calls + 1
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_vertical_advection_v, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_VERT_ADVECTION
call system_clock(profile_vert_advection_t1)
if(profile_vert_advection_rate > 0) then
  profile_vert_advection_v_seconds = profile_vert_advection_v_seconds + &
       real(profile_vert_advection_t1 - profile_vert_advection_t0)/real(profile_vert_advection_rate)
endif
profile_vert_advection_v_calls = profile_vert_advection_v_calls + 1
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_vertical_advection_t, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_VERT_ADVECTION
call system_clock(profile_vert_advection_t1)
if(profile_vert_advection_rate > 0) then
  profile_vert_advection_t_seconds = profile_vert_advection_t_seconds + &
       real(profile_vert_advection_t1 - profile_vert_advection_t0)/real(profile_vert_advection_rate)
endif
profile_vert_advection_t_calls = profile_vert_advection_t_calls + 1
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_horizontal_advection_temperature, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_advection, profile_dynamics_region_t0, profile_dynamics_region_rate)
call profile_dynamics_region_begin(profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_begin(profile_dynamics_deep_t0, profile_dynamics_deep_rate)
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_dt_t, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_transforms, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_vor_div_from_uv, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_transforms, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_phis_plus_ke, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_transforms, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_damping, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_leapfrog_update, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_future_div, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
call profile_dynamics_deep_begin(profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
call trans_spherical_to_grid(vors(:,:,:,future), vorg)
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_future_vor, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
call profile_dynamics_deep_begin(profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
call uv_grid_from_vor_div(vors(:,:,:,future), divs(:,:,:,future), ug(:,:,:,future), vg(:,:,:,future))
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_future_uv, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
call profile_dynamics_deep_begin(profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
call trans_spherical_to_grid(ts   (:,:,:,future), tg(:,:,:,future))
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_future_t, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
call profile_dynamics_deep_begin(profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
call trans_spherical_to_grid(ln_ps(:,:,  future), ln_psg)
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_transform_future_ln_ps, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_transforms, profile_dynamics_region_t0, profile_dynamics_region_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_update_tracers, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_compute_corrections, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
call profile_dynamics_deep_end(profile_deep_every_step_diagnostics, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
call profile_dynamics_region_end(profile_region_tracer_correction_diag, profile_dynamics_region_t0, profile_dynamics_region_rate)
call profile_dynamics_region_end(profile_region_spectral_step, profile_dynamics_step_t0, profile_dynamics_step_rate)
#endif
...
integer :: k
#ifdef PROFILE_FOUR_IN_ONE
integer :: profile_four_in_one_t0, profile_four_in_one_t1, profile_four_in_one_rate
#endif

#ifdef PROFILE_FOUR_IN_ONE
call system_clock(profile_four_in_one_t0, profile_four_in_one_rate)
#endif
...
#ifdef PROFILE_FOUR_IN_ONE
call system_clock(profile_four_in_one_t1)
if(profile_four_in_one_rate > 0) then
  profile_four_in_one_seconds = profile_four_in_one_seconds + &
       real(profile_four_in_one_t1 - profile_four_in_one_t0)/real(profile_four_in_one_rate)
endif
profile_four_in_one_calls = profile_four_in_one_calls + 1
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
    call profile_dynamics_deep_end(profile_deep_tracer_horizontal_advection, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
    call profile_dynamics_deep_end(profile_deep_tracer_vertical_advection, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
    call profile_dynamics_deep_end(profile_deep_tracer_grid_to_spectral, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
...
#ifdef PROFILE_DYNAMICS_DEEP
    call profile_dynamics_deep_end(profile_deep_tracer_spectral_to_grid, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
  else if(trim(tracer_attributes(ntr)%numerical_representation) == 'grid') then
...
#ifdef PROFILE_DYNAMICS_DEEP
    call profile_dynamics_deep_end(profile_deep_tracer_grid_horizontal_advection, profile_dynamics_deep_t0, profile_dynamics_deep_rate)
#endif
...
character(len=64) :: file, tr_name
#ifdef PROFILE_FOUR_IN_ONE
real :: profile_four_in_one_max_seconds, profile_four_in_one_avg_seconds
integer :: profile_four_in_one_max_calls
#endif
#ifdef PROFILE_VERT_ADVECTION
real :: profile_vert_advection_u_max_seconds, profile_vert_advection_v_max_seconds, profile_vert_advection_t_max_seconds
real :: profile_vert_advection_u_avg_seconds, profile_vert_advection_v_avg_seconds, profile_vert_advection_t_avg_seconds
real :: profile_vert_advection_total_seconds, profile_vert_advection_total_max_seconds, profile_vert_advection_total_avg_seconds
integer :: profile_vert_advection_u_max_calls, profile_vert_advection_v_max_calls, profile_vert_advection_t_max_calls
integer :: profile_vert_advection_total_calls, profile_vert_advection_total_max_calls
#endif
#ifdef PROFILE_DYNAMICS_REGIONS
real :: profile_dynamics_region_max_seconds, profile_dynamics_region_avg_seconds
integer :: profile_dynamics_region_max_calls, profile_dynamics_region_index
#endif
#ifdef PROFILE_DYNAMICS_DEEP
real :: profile_dynamics_deep_max_seconds, profile_dynamics_deep_avg_seconds
integer :: profile_dynamics_deep_max_calls, profile_dynamics_deep_index
#endif

if(.not.module_is_initialized) return

#ifdef PROFILE_FOUR_IN_ONE
profile_four_in_one_max_seconds = profile_four_in_one_seconds
profile_four_in_one_max_calls = profile_four_in_one_calls
call mpp_max(profile_four_in_one_max_seconds)
call mpp_max(profile_four_in_one_max_calls)
profile_four_in_one_avg_seconds = 0.0
if(profile_four_in_one_max_calls > 0) then
  profile_four_in_one_avg_seconds = profile_four_in_one_max_seconds / real(profile_four_in_one_max_calls)
endif
if(mpp_pe() == mpp_root_pe()) then
  write(*,*) 'PROFILE_FOUR_IN_ONE calls_max=', profile_four_in_one_max_calls, &
             ' seconds_max=', profile_four_in_one_max_seconds, &
             ' avg_seconds_per_call_max=', profile_four_in_one_avg_seconds
endif
#endif

#ifdef PROFILE_DYNAMICS_REGIONS
do profile_dynamics_region_index = 1, profile_dynamics_region_count
  profile_dynamics_region_max_seconds = profile_dynamics_region_seconds(profile_dynamics_region_index)
  profile_dynamics_region_max_calls = profile_dynamics_region_calls(profile_dynamics_region_index)
  call mpp_max(profile_dynamics_region_max_seconds)
  call mpp_max(profile_dynamics_region_max_calls)
  profile_dynamics_region_avg_seconds = 0.0
  if(profile_dynamics_region_max_calls > 0) then
    profile_dynamics_region_avg_seconds = profile_dynamics_region_max_seconds / real(profile_dynamics_region_max_calls)
  endif
  if(mpp_pe() == mpp_root_pe()) then
    write(*,*) 'PROFILE_DYNAMICS_REGION name=', trim(profile_dynamics_region_names(profile_dynamics_region_index)), &
               ' calls_max=', profile_dynamics_region_max_calls, &
               ' time_max=', profile_dynamics_region_max_seconds, &
               ' avg_max=', profile_dynamics_region_avg_seconds
  endif
enddo
#endif

#ifdef PROFILE_DYNAMICS_DEEP
do profile_dynamics_deep_index = 1, profile_dynamics_deep_count
  profile_dynamics_deep_max_seconds = profile_dynamics_deep_seconds(profile_dynamics_deep_index)
  profile_dynamics_deep_max_calls = profile_dynamics_deep_calls(profile_dynamics_deep_index)
  call mpp_max(profile_dynamics_deep_max_seconds)
  call mpp_max(profile_dynamics_deep_max_calls)
  profile_dynamics_deep_avg_seconds = 0.0
  if(profile_dynamics_deep_max_calls > 0) then
    profile_dynamics_deep_avg_seconds = profile_dynamics_deep_max_seconds / real(profile_dynamics_deep_max_calls)
  endif
  if(mpp_pe() == mpp_root_pe()) then
    write(*,*) 'PROFILE_DYNAMICS_DEEP name=', trim(profile_dynamics_deep_names(profile_dynamics_deep_index)), &
               ' calls_max=', profile_dynamics_deep_max_calls, &
               ' time_max=', profile_dynamics_deep_max_seconds, &
               ' avg_max=', profile_dynamics_deep_avg_seconds
  endif
enddo
#endif

#ifdef PROFILE_VERT_ADVECTION
profile_vert_advection_u_max_seconds = profile_vert_advection_u_seconds
profile_vert_advection_v_max_seconds = profile_vert_advection_v_seconds
profile_vert_advection_t_max_seconds = profile_vert_advection_t_seconds
profile_vert_advection_u_max_calls = profile_vert_advection_u_calls
profile_vert_advection_v_max_calls = profile_vert_advection_v_calls
profile_vert_advection_t_max_calls = profile_vert_advection_t_calls
profile_vert_advection_total_seconds = profile_vert_advection_u_seconds + &
                                       profile_vert_advection_v_seconds + &
                                       profile_vert_advection_t_seconds
profile_vert_advection_total_calls = profile_vert_advection_u_calls + &
                                     profile_vert_advection_v_calls + &
                                     profile_vert_advection_t_calls
profile_vert_advection_total_max_seconds = profile_vert_advection_total_seconds
profile_vert_advection_total_max_calls = profile_vert_advection_total_calls
call mpp_max(profile_vert_advection_u_max_seconds)
call mpp_max(profile_vert_advection_v_max_seconds)
call mpp_max(profile_vert_advection_t_max_seconds)
call mpp_max(profile_vert_advection_total_max_seconds)
call mpp_max(profile_vert_advection_u_max_calls)
call mpp_max(profile_vert_advection_v_max_calls)
call mpp_max(profile_vert_advection_t_max_calls)
call mpp_max(profile_vert_advection_total_max_calls)
profile_vert_advection_u_avg_seconds = 0.0
profile_vert_advection_v_avg_seconds = 0.0
profile_vert_advection_t_avg_seconds = 0.0
profile_vert_advection_total_avg_seconds = 0.0
if(profile_vert_advection_u_max_calls > 0) then
  profile_vert_advection_u_avg_seconds = profile_vert_advection_u_max_seconds / real(profile_vert_advection_u_max_calls)
endif
if(profile_vert_advection_v_max_calls > 0) then
  profile_vert_advection_v_avg_seconds = profile_vert_advection_v_max_seconds / real(profile_vert_advection_v_max_calls)
endif
if(profile_vert_advection_t_max_calls > 0) then
  profile_vert_advection_t_avg_seconds = profile_vert_advection_t_max_seconds / real(profile_vert_advection_t_max_calls)
endif
if(profile_vert_advection_total_max_calls > 0) then
  profile_vert_advection_total_avg_seconds = profile_vert_advection_total_max_seconds / real(profile_vert_advection_total_max_calls)
endif
if(mpp_pe() == mpp_root_pe()) then
  write(*,*) 'PROFILE_VERT_ADVECTION_CALLSITE field=u calls_max=', profile_vert_advection_u_max_calls, &
             ' time_max=', profile_vert_advection_u_max_seconds, &
             ' avg_max=', profile_vert_advection_u_avg_seconds
  write(*,*) 'PROFILE_VERT_ADVECTION_CALLSITE field=v calls_max=', profile_vert_advection_v_max_calls, &
             ' time_max=', profile_vert_advection_v_max_seconds, &
             ' avg_max=', profile_vert_advection_v_avg_seconds
  write(*,*) 'PROFILE_VERT_ADVECTION_CALLSITE field=t calls_max=', profile_vert_advection_t_max_calls, &
             ' time_max=', profile_vert_advection_t_max_seconds, &
             ' avg_max=', profile_vert_advection_t_avg_seconds
  write(*,*) 'PROFILE_VERT_ADVECTION_CALLSITE total calls_max=', profile_vert_advection_total_max_calls, &
             ' time_max=', profile_vert_advection_total_max_seconds, &
             ' avg_max=', profile_vert_advection_total_avg_seconds
endif
#endif
