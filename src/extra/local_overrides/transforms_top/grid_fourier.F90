...
integer, parameter :: profile_grid_fourier_forward_total = 1
integer, parameter :: profile_grid_fourier_forward_pack = 2
integer, parameter :: profile_grid_fourier_forward_fft = 3
integer, parameter :: profile_grid_fourier_inverse_total = 4
integer, parameter :: profile_grid_fourier_inverse_fft = 5
integer, parameter :: profile_grid_fourier_inverse_unpack = 6
integer, parameter :: profile_grid_fourier_count = 6
character(len=40), parameter, dimension(profile_grid_fourier_count) :: profile_grid_fourier_names = (/ character(len=40) :: &
     'fft_forward_total                     ', &
     'fft_forward_pack                      ', &
     'fft_forward_kernel                    ', &
     'fft_inverse_total                     ', &
     'fft_inverse_kernel                    ', &
     'fft_inverse_unpack                    ' /)
real, dimension(profile_grid_fourier_count) :: profile_grid_fourier_seconds = 0.0
integer, dimension(profile_grid_fourier_count) :: profile_grid_fourier_calls = 0
#endif
...
!------------------------------------------------------------------------------------------------------
#ifdef PROFILE_TRANSFORMS_STAGE
subroutine profile_grid_fourier_begin(t0, rate)
integer, intent(out) :: t0, rate
call system_clock(t0, rate)
end subroutine profile_grid_fourier_begin

!------------------------------------------------------------------------------------------------------
subroutine profile_grid_fourier_end(timer_id, t0, rate)
integer, intent(in) :: timer_id, t0, rate
integer :: t1
call system_clock(t1)
if(rate > 0) then
  profile_grid_fourier_seconds(timer_id) = profile_grid_fourier_seconds(timer_id) + real(t1 - t0)/real(rate)
endif
profile_grid_fourier_calls(timer_id) = profile_grid_fourier_calls(timer_id) + 1
end subroutine profile_grid_fourier_end

!------------------------------------------------------------------------------------------------------
subroutine profile_grid_fourier_report
real :: profile_grid_fourier_max_seconds, profile_grid_fourier_avg_seconds
integer :: profile_grid_fourier_max_calls, profile_grid_fourier_index

do profile_grid_fourier_index = 1, profile_grid_fourier_count
  profile_grid_fourier_max_seconds = profile_grid_fourier_seconds(profile_grid_fourier_index)
  profile_grid_fourier_max_calls = profile_grid_fourier_calls(profile_grid_fourier_index)
  call mpp_max(profile_grid_fourier_max_seconds)
  call mpp_max(profile_grid_fourier_max_calls)
  profile_grid_fourier_avg_seconds = 0.0
  if(profile_grid_fourier_max_calls > 0) then
    profile_grid_fourier_avg_seconds = profile_grid_fourier_max_seconds / real(profile_grid_fourier_max_calls)
  endif
  if(mpp_pe() == mpp_root_pe()) then
    write(*,*) 'PROFILE_TRANSFORM_STAGE name=', trim(profile_grid_fourier_names(profile_grid_fourier_index)), &
               ' calls_max=', profile_grid_fourier_max_calls, &
               ' time_max=', profile_grid_fourier_max_seconds, &
               ' avg_max=', profile_grid_fourier_avg_seconds
  endif
enddo
end subroutine profile_grid_fourier_report
#endif
...
integer :: profile_stage_t0, profile_stage_rate
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_grid_fourier_begin(profile_total_t0, profile_total_rate)
call profile_grid_fourier_begin(profile_stage_t0, profile_stage_rate)
#endif
grid1(1:size(grid,1),:,:) = grid
grid1(size(grid,1)+1,:,:) = grid(1,:,:)
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_grid_fourier_end(profile_grid_fourier_forward_pack, profile_stage_t0, profile_stage_rate)
call profile_grid_fourier_begin(profile_stage_t0, profile_stage_rate)
#endif
fourier = fft_grid_to_fourier(grid1)
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_grid_fourier_end(profile_grid_fourier_forward_fft, profile_stage_t0, profile_stage_rate)
call profile_grid_fourier_end(profile_grid_fourier_forward_total, profile_total_t0, profile_total_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_grid_fourier_end(profile_grid_fourier_inverse_fft, profile_stage_t0, profile_stage_rate)
call profile_grid_fourier_begin(profile_stage_t0, profile_stage_rate)
#endif
grid = grid1(1:2*(size(fourier,1)-1),:,:)
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_grid_fourier_end(profile_grid_fourier_inverse_unpack, profile_stage_t0, profile_stage_rate)
call profile_grid_fourier_end(profile_grid_fourier_inverse_total, profile_total_t0, profile_total_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_grid_fourier_report
#endif
deallocate(deg_lon)
!call fft_end
