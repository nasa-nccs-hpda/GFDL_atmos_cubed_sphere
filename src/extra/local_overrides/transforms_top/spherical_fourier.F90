...
#ifdef PROFILE_TRANSFORMS_STAGE
integer, parameter :: profile_spherical_fourier_s2f_total = 1
integer, parameter :: profile_spherical_fourier_s2f_loop = 2
integer, parameter :: profile_spherical_fourier_f2s_total = 3
integer, parameter :: profile_spherical_fourier_f2s_loop = 4
integer, parameter :: profile_spherical_fourier_count = 4
character(len=40), parameter, dimension(profile_spherical_fourier_count) :: profile_spherical_fourier_names = (/ character(len=40) :: &
     'legendre_spherical_to_fourier_total  ', &
     'legendre_spherical_to_fourier_loop   ', &
     'legendre_fourier_to_spherical_total  ', &
     'legendre_fourier_to_spherical_loop   ' /)
real, dimension(profile_spherical_fourier_count) :: profile_spherical_fourier_seconds = 0.0
integer, dimension(profile_spherical_fourier_count) :: profile_spherical_fourier_calls = 0
#endif
...
!-----------------------------------------------------------------------
#ifdef PROFILE_TRANSFORMS_STAGE
subroutine profile_spherical_fourier_begin(t0, rate)
integer, intent(out) :: t0, rate
call system_clock(t0, rate)
end subroutine profile_spherical_fourier_begin

!-----------------------------------------------------------------------
subroutine profile_spherical_fourier_end(timer_id, t0, rate)
integer, intent(in) :: timer_id, t0, rate
integer :: t1
call system_clock(t1)
if(rate > 0) then
  profile_spherical_fourier_seconds(timer_id) = profile_spherical_fourier_seconds(timer_id) + real(t1 - t0)/real(rate)
endif
profile_spherical_fourier_calls(timer_id) = profile_spherical_fourier_calls(timer_id) + 1
end subroutine profile_spherical_fourier_end

!-----------------------------------------------------------------------
subroutine profile_spherical_fourier_report
real :: profile_spherical_fourier_max_seconds, profile_spherical_fourier_avg_seconds
integer :: profile_spherical_fourier_max_calls, profile_spherical_fourier_index

do profile_spherical_fourier_index = 1, profile_spherical_fourier_count
  profile_spherical_fourier_max_seconds = profile_spherical_fourier_seconds(profile_spherical_fourier_index)
  profile_spherical_fourier_max_calls = profile_spherical_fourier_calls(profile_spherical_fourier_index)
  call mpp_max(profile_spherical_fourier_max_seconds)
  call mpp_max(profile_spherical_fourier_max_calls)
  profile_spherical_fourier_avg_seconds = 0.0
  if(profile_spherical_fourier_max_calls > 0) then
    profile_spherical_fourier_avg_seconds = profile_spherical_fourier_max_seconds / real(profile_spherical_fourier_max_calls)
  endif
  if(mpp_pe() == mpp_root_pe()) then
    write(*,*) 'PROFILE_TRANSFORM_STAGE name=', trim(profile_spherical_fourier_names(profile_spherical_fourier_index)), &
               ' calls_max=', profile_spherical_fourier_max_calls, &
               ' time_max=', profile_spherical_fourier_max_seconds, &
               ' avg_max=', profile_spherical_fourier_avg_seconds
  endif
enddo
end subroutine profile_spherical_fourier_report
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
integer :: profile_total_t0, profile_total_rate
integer :: profile_loop_t0, profile_loop_rate
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_spherical_fourier_begin(profile_total_t0, profile_total_rate)
call profile_spherical_fourier_begin(profile_loop_t0, profile_loop_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_spherical_fourier_end(profile_spherical_fourier_s2f_loop, profile_loop_t0, profile_loop_rate)
call profile_spherical_fourier_end(profile_spherical_fourier_s2f_total, profile_total_t0, profile_total_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_spherical_fourier_end(profile_spherical_fourier_f2s_loop, profile_loop_t0, profile_loop_rate)
call profile_spherical_fourier_end(profile_spherical_fourier_f2s_total, profile_total_t0, profile_total_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_STAGE
call profile_spherical_fourier_report
#endif
