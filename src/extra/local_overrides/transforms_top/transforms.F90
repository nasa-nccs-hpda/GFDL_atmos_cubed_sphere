...
use mpp_mod, only: mpp_chksum, mpp_error, mpp_npes, mpp_sum, mpp_sync, mpp_sync_self, mpp_transmit, mpp_max
...
#ifdef PROFILE_TRANSFORMS_TOP
integer, parameter :: profile_transform_g2s_direct = 1
integer, parameter :: profile_transform_s2g_direct = 2
integer, parameter :: profile_transform_vor_div = 3
integer, parameter :: profile_transform_uv_from_vor_div = 4
integer, parameter :: profile_transform_g2s_nested_vor_div = 5
integer, parameter :: profile_transform_s2g_nested_uv = 6
integer, parameter :: profile_transform_top_count = 6
character(len=40), parameter, dimension(profile_transform_top_count) :: profile_transform_top_names = (/ character(len=40) :: &
     'grid_to_spherical_direct              ', &
     'spherical_to_grid_direct              ', &
     'vor_div_from_uv_grid_composite        ', &
     'uv_grid_from_vor_div_composite        ', &
     'grid_to_spherical_nested_vor_div      ', &
     'spherical_to_grid_nested_uv           ' /)
real, dimension(profile_transform_top_count) :: profile_transform_top_seconds = 0.0
integer, dimension(profile_transform_top_count) :: profile_transform_top_calls = 0
integer :: profile_transform_vor_div_depth = 0
integer :: profile_transform_uv_depth = 0
#endif

#ifdef PROFILE_TRANSFORMS_WRAPPER
integer, parameter :: profile_wrapper_s2g_spectral_y_sum = 1
integer, parameter :: profile_wrapper_s2g_reverse_transpose = 2
integer, parameter :: profile_wrapper_s2g_fourier_truncation = 3
integer, parameter :: profile_wrapper_s2g_grid_extract = 4
integer, parameter :: profile_wrapper_g2s_grid_copy = 5
integer, parameter :: profile_wrapper_g2s_x_update = 6
integer, parameter :: profile_wrapper_g2s_fourier_truncation = 7
integer, parameter :: profile_wrapper_g2s_transpose = 8
integer, parameter :: profile_wrapper_g2s_spectral_truncation = 9
integer, parameter :: profile_wrapper_vor_div_u_copy = 10
integer, parameter :: profile_wrapper_vor_div_u_divide_by_cos = 11
integer, parameter :: profile_wrapper_vor_div_v_copy = 12
integer, parameter :: profile_wrapper_vor_div_v_divide_by_cos = 13
integer, parameter :: profile_wrapper_vor_div_compute = 14
integer, parameter :: profile_wrapper_vor_div_truncation = 15
integer, parameter :: profile_wrapper_uv_compute_ucos_vcos = 16
integer, parameter :: profile_wrapper_uv_u_divide_by_cos = 17
integer, parameter :: profile_wrapper_uv_v_divide_by_cos = 18
integer, parameter :: profile_wrapper_transpose_pack = 19
integer, parameter :: profile_wrapper_transpose_sync_self = 20
integer, parameter :: profile_wrapper_transpose_transmit = 21
integer, parameter :: profile_wrapper_transpose_final_sync = 22
integer, parameter :: profile_wrapper_reverse_transpose_transmit = 23
integer, parameter :: profile_wrapper_reverse_transpose_unpack = 24
integer, parameter :: profile_wrapper_reverse_transpose_final_sync = 25
integer, parameter :: profile_wrapper_count = 25
character(len=48), parameter, dimension(profile_wrapper_count) :: profile_wrapper_names = (/ character(len=48) :: &
     's2g_spectral_y_sum                            ', &
...
real, dimension(profile_wrapper_count) :: profile_wrapper_seconds = 0.0
integer, dimension(profile_wrapper_count) :: profile_wrapper_calls = 0
#endif
...
!---------------------------------------------------------------------------
#ifdef PROFILE_TRANSFORMS_TOP
subroutine profile_transform_top_begin(t0, rate)
integer, intent(out) :: t0, rate
call system_clock(t0, rate)
end subroutine profile_transform_top_begin

!---------------------------------------------------------------------------
subroutine profile_transform_top_end(timer_id, t0, rate)
integer, intent(in) :: timer_id, t0, rate
integer :: t1
call system_clock(t1)
if(rate > 0) then
  profile_transform_top_seconds(timer_id) = profile_transform_top_seconds(timer_id) + real(t1 - t0)/real(rate)
endif
profile_transform_top_calls(timer_id) = profile_transform_top_calls(timer_id) + 1
end subroutine profile_transform_top_end

!---------------------------------------------------------------------------
subroutine profile_transform_top_report
real :: profile_transform_top_max_seconds, profile_transform_top_avg_seconds
real :: profile_transform_nonoverlap_seconds, profile_transform_nonoverlap_max_seconds
integer :: profile_transform_top_max_calls, profile_transform_index
integer :: profile_transform_nonoverlap_calls, profile_transform_nonoverlap_max_calls

do profile_transform_index = 1, profile_transform_top_count
  profile_transform_top_max_seconds = profile_transform_top_seconds(profile_transform_index)
  profile_transform_top_max_calls = profile_transform_top_calls(profile_transform_index)
  call mpp_max(profile_transform_top_max_seconds)
  call mpp_max(profile_transform_top_max_calls)
  profile_transform_top_avg_seconds = 0.0
  if(profile_transform_top_max_calls > 0) then
    profile_transform_top_avg_seconds = profile_transform_top_max_seconds / real(profile_transform_top_max_calls)
  endif
  if(mpp_pe() == mpp_root_pe()) then
    write(*,*) 'PROFILE_TRANSFORM_TOP name=', trim(profile_transform_top_names(profile_transform_index)), &
               ' calls_max=', profile_transform_top_max_calls, &
               ' time_max=', profile_transform_top_max_seconds, &
               ' avg_max=', profile_transform_top_avg_seconds
  endif
enddo

profile_transform_nonoverlap_seconds = profile_transform_top_seconds(profile_transform_g2s_direct) + &
     profile_transform_top_seconds(profile_transform_s2g_direct) + &
     profile_transform_top_seconds(profile_transform_vor_div) + &
     profile_transform_top_seconds(profile_transform_uv_from_vor_div)
profile_transform_nonoverlap_calls = profile_transform_top_calls(profile_transform_g2s_direct) + &
     profile_transform_top_calls(profile_transform_s2g_direct) + &
     profile_transform_top_calls(profile_transform_vor_div) + &
     profile_transform_top_calls(profile_transform_uv_from_vor_div)
profile_transform_nonoverlap_max_seconds = profile_transform_nonoverlap_seconds
profile_transform_nonoverlap_max_calls = profile_transform_nonoverlap_calls
call mpp_max(profile_transform_nonoverlap_max_seconds)
call mpp_max(profile_transform_nonoverlap_max_calls)
profile_transform_top_avg_seconds = 0.0
if(profile_transform_nonoverlap_max_calls > 0) then
  profile_transform_top_avg_seconds = profile_transform_nonoverlap_max_seconds / real(profile_transform_nonoverlap_max_calls)
endif
if(mpp_pe() == mpp_root_pe()) then
  write(*,*) 'PROFILE_TRANSFORM_TOP name=nonoverlap_total', &
             ' calls_max=', profile_transform_nonoverlap_max_calls, &
             ' time_max=', profile_transform_nonoverlap_max_seconds, &
             ' avg_max=', profile_transform_top_avg_seconds
endif
end subroutine profile_transform_top_report
#endif

!---------------------------------------------------------------------------
#ifdef PROFILE_TRANSFORMS_WRAPPER
subroutine profile_wrapper_begin(t0, rate)
integer, intent(out) :: t0, rate
call system_clock(t0, rate)
end subroutine profile_wrapper_begin

!---------------------------------------------------------------------------
subroutine profile_wrapper_end(timer_id, t0, rate)
integer, intent(in) :: timer_id, t0, rate
integer :: t1
call system_clock(t1)
if(rate > 0) then
  profile_wrapper_seconds(timer_id) = profile_wrapper_seconds(timer_id) + real(t1 - t0)/real(rate)
endif
profile_wrapper_calls(timer_id) = profile_wrapper_calls(timer_id) + 1
end subroutine profile_wrapper_end

!---------------------------------------------------------------------------
subroutine profile_wrapper_report
real :: profile_wrapper_max_seconds, profile_wrapper_avg_seconds
integer :: profile_wrapper_max_calls, profile_wrapper_index

do profile_wrapper_index = 1, profile_wrapper_count
  profile_wrapper_max_seconds = profile_wrapper_seconds(profile_wrapper_index)
  profile_wrapper_max_calls = profile_wrapper_calls(profile_wrapper_index)
  call mpp_max(profile_wrapper_max_seconds)
  call mpp_max(profile_wrapper_max_calls)
  profile_wrapper_avg_seconds = 0.0
  if(profile_wrapper_max_calls > 0) then
    profile_wrapper_avg_seconds = profile_wrapper_max_seconds / real(profile_wrapper_max_calls)
  endif
  if(mpp_pe() == mpp_root_pe()) then
    write(*,*) 'PROFILE_TRANSFORM_WRAPPER name=', trim(profile_wrapper_names(profile_wrapper_index)), &
               ' calls_max=', profile_wrapper_max_calls, &
               ' time_max=', profile_wrapper_max_seconds, &
               ' avg_max=', profile_wrapper_avg_seconds
  endif
enddo
end subroutine profile_wrapper_report
#endif
...
#ifdef PROFILE_TRANSFORMS_TOP
integer :: profile_transform_t0, profile_transform_rate, profile_transform_timer_id
#endif
#ifdef PROFILE_TRANSFORMS_WRAPPER
integer :: profile_wrapper_t0, profile_wrapper_rate
#endif
...
#ifdef PROFILE_TRANSFORMS_TOP
if(profile_transform_uv_depth > 0) then
  profile_transform_timer_id = profile_transform_s2g_nested_uv
else
  profile_transform_timer_id = profile_transform_s2g_direct
endif
call profile_transform_top_begin(profile_transform_t0, profile_transform_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
    call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
    call mpp_sum( fourier_s          , size(fourier_s(:,:,:,:)), pelist )
#ifdef PROFILE_TRANSFORMS_WRAPPER
    call profile_wrapper_end(profile_wrapper_s2g_spectral_y_sum, profile_wrapper_t0, profile_wrapper_rate)
#endif
end if
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_s2g_reverse_transpose, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_s2g_fourier_truncation, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
    call profile_wrapper_end(profile_wrapper_s2g_grid_extract, profile_wrapper_t0, profile_wrapper_rate)
#endif
else
...
#ifdef PROFILE_TRANSFORMS_TOP
call profile_transform_top_end(profile_transform_timer_id, profile_transform_t0, profile_transform_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_TOP
if(profile_transform_vor_div_depth > 0) then
  profile_transform_timer_id = profile_transform_g2s_nested_vor_div
else
  profile_transform_timer_id = profile_transform_g2s_direct
endif
call profile_transform_top_begin(profile_transform_t0, profile_transform_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
    call profile_wrapper_end(profile_wrapper_g2s_grid_copy, profile_wrapper_t0, profile_wrapper_rate)
    call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
    call mpp_update_domains( grid_xglobal, grid_domain, XUPDATE )
#ifdef PROFILE_TRANSFORMS_WRAPPER
    call profile_wrapper_end(profile_wrapper_g2s_x_update, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_g2s_fourier_truncation, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_g2s_transpose, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
  call profile_wrapper_end(profile_wrapper_g2s_spectral_truncation, profile_wrapper_t0, profile_wrapper_rate)
#endif
end if
...
#ifdef PROFILE_TRANSFORMS_TOP
integer :: profile_transform_t0, profile_transform_rate
#endif
#ifdef PROFILE_TRANSFORMS_WRAPPER
integer :: profile_wrapper_t0, profile_wrapper_rate
#endif
...
#ifdef PROFILE_TRANSFORMS_TOP
call profile_transform_top_begin(profile_transform_t0, profile_transform_rate)
profile_transform_uv_depth = profile_transform_uv_depth + 1
#endif
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_uv_compute_ucos_vcos, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_uv_u_divide_by_cos, profile_wrapper_t0, profile_wrapper_rate)
call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
call divide_by_cos              (v_grid)
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_uv_v_divide_by_cos, profile_wrapper_t0, profile_wrapper_rate)
#endif
#ifdef PROFILE_TRANSFORMS_TOP
profile_transform_uv_depth = profile_transform_uv_depth - 1
call profile_transform_top_end(profile_transform_uv_from_vor_div, profile_transform_t0, profile_transform_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_TOP
call profile_transform_top_begin(profile_transform_t0, profile_transform_rate)
profile_transform_vor_div_depth = profile_transform_vor_div_depth + 1
#endif
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
grid_tmp = u_grid
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_vor_div_u_copy, profile_wrapper_t0, profile_wrapper_rate)
call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
call divide_by_cos(grid_tmp)
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_vor_div_u_divide_by_cos, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
grid_tmp = v_grid
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_vor_div_v_copy, profile_wrapper_t0, profile_wrapper_rate)
call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
call divide_by_cos(grid_tmp)
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_vor_div_v_divide_by_cos, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_end(profile_wrapper_vor_div_compute, profile_wrapper_t0, profile_wrapper_rate)
#endif
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
  call profile_wrapper_end(profile_wrapper_vor_div_truncation, profile_wrapper_t0, profile_wrapper_rate)
#endif
else
#ifdef PROFILE_TRANSFORMS_WRAPPER
  call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
...
#ifdef PROFILE_TRANSFORMS_TOP
profile_transform_vor_div_depth = profile_transform_vor_div_depth - 1
call profile_transform_top_end(profile_transform_vor_div, profile_transform_t0, profile_transform_rate)
#endif
...
!-------------------------------------------------------------------------
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
     call profile_wrapper_end(profile_wrapper_reverse_transpose_transmit, profile_wrapper_t0, profile_wrapper_rate)
     call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
     nget = 0
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
     call profile_wrapper_end(profile_wrapper_reverse_transpose_unpack, profile_wrapper_t0, profile_wrapper_rate)
#endif
  end do
#ifdef PROFILE_TRANSFORMS_WRAPPER
  call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
  ...
  call mpp_sync()
#ifdef PROFILE_TRANSFORMS_WRAPPER
  call profile_wrapper_end(profile_wrapper_reverse_transpose_final_sync, profile_wrapper_t0, profile_wrapper_rate)
#endif
  return
...
!-------------------------------------------------------------------------
  ...
  do ii = 1,spectral_layout(1)-1
     ...
     call mpp_sync_self()
#ifdef PROFILE_TRANSFORMS_WRAPPER
     call profile_wrapper_end(profile_wrapper_transpose_sync_self, profile_wrapper_t0, profile_wrapper_rate)
     call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
#endif
     do k = 1,size(fourier_g,3)
        do j = 1,size(fourier_g,2)
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
     call profile_wrapper_end(profile_wrapper_transpose_pack, profile_wrapper_t0, profile_wrapper_rate)
#endif
     ! Force use of "scalar", integer pointer mpp interface
#ifdef PROFILE_TRANSFORMS_WRAPPER
     call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
...
#ifdef PROFILE_TRANSFORMS_WRAPPER
     call profile_wrapper_end(profile_wrapper_transpose_transmit, profile_wrapper_t0, profile_wrapper_rate)
#endif
  end do
#ifdef PROFILE_TRANSFORMS_WRAPPER
  call profile_wrapper_begin(profile_wrapper_t0, profile_wrapper_rate)
  ...
  call mpp_sync()
#ifdef PROFILE_TRANSFORMS_WRAPPER
  call profile_wrapper_end(profile_wrapper_transpose_final_sync, profile_wrapper_t0, profile_wrapper_rate)
#endif
  return
...
#ifdef PROFILE_TRANSFORMS_TOP
call profile_transform_top_report
#endif
#ifdef PROFILE_TRANSFORMS_WRAPPER
call profile_wrapper_report
#endif
