...
| `cpu_hybrid` | `/explore/nobackup/people/jli30/SystemTesting/Isca/isca_data/held_suarez_fv_kernels_1day/run0001/atmos_monthly.nc` | True |
| `cuda_hybrid` | `/explore/nobackup/people/jli30/SystemTesting/Isca/isca_data/held_suarez_fv_kernels_cuda_resident_1day/run0001/atmos_monthly.nc` | True |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Fortran vs CPU hybrid | True | 4 | 0 | 9.969210e+36 | inf | inf | inf |
| Fortran vs CUDA hybrid | True | 4 | 0 | 9.969210e+36 | inf | inf | inf |
...
|---|---|---:|---:|---:|---:|---:|---:|
| `ps` | `1x64x128` | 9.969210e+36 | inf | 9.981344e+31 | inf | 1.000266e+05 | inf |
| `temp` | `1x25x64x128` | 9.969210e+36 | inf | 3.789021e+34 | inf | 2.635305e+02 | inf |
| `ucomp` | `1x25x64x128` | 9.969210e+36 | inf | inf | inf | 1.563309e-01 | inf |
| `vcomp` | `1x25x64x128` | 9.969210e+36 | inf | inf | inf | 3.209934e-06 | inf |
...
| Variable | Shape | Max Abs Error | RMSE | Max Relative Error | Relative L2 Error | Baseline Mean | Candidate Mean |
|---|---|---:|---:|---:|---:|---:|---:|
| `ps` | `1x64x128` | 0 | 0 | 0 | 0 | inf | inf |
| `temp` | `1x25x64x128` | 0 | 0 | 0 | 0 | inf | inf |
| `ucomp` | `1x25x64x128` | 0 | 0 | 0 | 0 | inf | inf |
| `vcomp` | `1x25x64x128` | 0 | 0 | 0 | 0 | inf | inf |
