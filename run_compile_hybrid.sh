...
export USE_CUDA_GRID_FOURIER=${USE_CUDA_GRID_FOURIER:-0}
export USE_CUDA_SPHERICAL_FOURIER=${USE_CUDA_SPHERICAL_FOURIER:-0}
...
export USE_CUDA_TRANSFORMS=${USE_CUDA_TRANSFORMS}
export USE_CUDA_GRID_FOURIER=${USE_CUDA_GRID_FOURIER}
export USE_CUDA_SPHERICAL_FOURIER=${USE_CUDA_SPHERICAL_FOURIER}
