...
EXPERIMENT=held_suarez_fv_kernels_cuda_persistent_1day
LOG="${GFDL_BASE}/logs/fv_kernels_cuda_persistent_1day.log"

mkdir -p "${GFDL_BASE}/logs"
exec > >(tee "${LOG}") 2>&1

echo "=== Held-Suarez persistent CUDA FV kernels: 1-day smoke ==="
